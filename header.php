...
<body <?php body_class(); ?>>
    ...
    <header class="cc-header">
                ...
                <div class="cc-header__top-container">
                    <div class="cc-header__left">
                        ...
                        <div class="cc-header__logo">
                            ...
                            $custom_logo = am24h_get_accessible_custom_logo_markup($home_label, true);
        ...
        <div class="cc-header__bottom">
            <div class="cc-container">
                <div class="cc-header__bottom-container">
                    <?php
                    wp_nav_menu(array(
                        'theme_location' => 'header-menu',
                        'menu_class' => 'cc-header__bottom-menu',
                        'container' => false,
                        'fallback_cb' => false, // Do not show fallback if no menu is assigned.
                        'walker' => new class extends Walker_Nav_Menu {
                            public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
                            {
                                ...
                                $atts['class'] = 'cc-btn cc-btn--small cc-btn--secondary';
        ...
        <div class="cc-mobile-menu">
            <div class="cc-mobile-menu__overlay"></div>
            <div class="cc-mobile-menu__content">
                <div class="cc-mobile-menu__header">
                    <div class="cc-mobile-menu__search">
                        <?php get_search_form(); ?>
                    </div>
                ...
                <nav class="cc-mobile-menu__nav">
                    ...
                    wp_nav_menu(array(
                        ...
                        'walker' => new class extends Walker_Nav_Menu {
                            ...
                            {
                                $output .= '<ul class="cc-mobile-menu__list">';
                            }
                            ...
                            public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
                            {
                                $output .= '<li class="cc-mobile-menu__item">';
                                $output .= '<a href="' . esc_url($item->url) . '" class="cc-mobile-menu__link">';
                                $title = apply_filters('the_title', $item->title, $item->ID);
